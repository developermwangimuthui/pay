...
/*$email="barshanhassan@gmail.com";
$message="hy this is work";
$subject="testing";*/
...
try {
    ...
    $mail->Host = 'mail.pfaccounts.com';  // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'contact@pfaccounts.com';                 // SMTP username
    $mail->Password = 'TluLK!7_JK';                           // SMTP password
    $mail->SMTPSecure = 'tsl';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('contact@pfaccounts.com', 'Pfaccounts ');
    $mail->addAddress($email, '');     // Add a recipient
    //$mail->addAddress('ellen@example.com');               // Name is optional
    $mail->addReplyTo('info@pfaccounts.com', 'Info Pfaccounts');
	//$mail->addReplyTo('info@pfaccounts.com', 'Fayyaz Win Win Associate');
              ...
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  ...
                  <tr>
                    ...
                    <center style="margin-bottom: 50px !important;"> <img src="https://pfaccounts.com/wp-content/uploads/2019/10/pfa-2.png" alt="Image" ></center>
                      ...
                      <div class="column" style="width:100%;max-width:350px;display:inline-block;vertical-align:top;">
                        <table class="contents" style="border-spacing:0; width:100%">
                          <tr>
                            ...
                            <td width="61%" align="left" valign="middle" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><p style="color:#787777; font-size:13px; text-align:left; font-family: Verdana, Geneva, sans-serif"> Copyright &copy;  2019-2020 Premium Freelancing Accounts All rights reserved.<br />
                                </td>
                          </tr>
                        </table>
                      </div>
