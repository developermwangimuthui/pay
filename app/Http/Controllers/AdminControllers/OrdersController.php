...
class OrdersController extends Controller
{
    ...
    public function vieworder(Request $request, $id)
    {
        ...
        /*        echo '<pre>';echo print_r($order);exit;*/
        ...
        // dd($orders_status_history,$orders_status);
    ...
    public function updateOrder(Request $request)
    {
        ...
        if ($old_orders_status == $orders_status) {
            ...
            /*echo '<pre>';echo print_r($orders);echo $orders[0]->email;exit;*/
    ...
    public function invoiceprint(Request $request)
    {
        ...
        return view("admin.Orders.newinvoice", $title)->with('data', $ordersData);
    }
    public function downloadPdf(Request $request)
    {
        ...
        $data= $ordersData;
        // dd($data);
        $pdf = PDF::loadView('admin.Orders.newinvoice',compact('data'));
