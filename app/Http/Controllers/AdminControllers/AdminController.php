...
class AdminController extends Controller
{
    ...
    public function mail(Request $request){
        ...
        $alert->sendEmail($email,$emailmessage,$emailsubject);
    }
...
54 Beedstrasse, Düsseldorf, 40468, Germany</p>';
            ...
            return redirect('admin/forgotPassword')->with('forgotPassError', Lang::get("Email does not Exist"));
        }

    }
    public function ExistUser($email){
        $existUser = DB::table('users')->where('email', $email)->first();
        return $existUser;
    }
