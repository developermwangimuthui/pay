...
class Payments_setting extends Model
{
    ...
    public function fetchPayPal()
    {
        ...
        $paypal = DB::table('payment_description')->get();
        return $paypal;
    }
    ...
    public function updaterecord($request, $env)
    {
        $id = $request->id;
        ...
        $r = DB::table('payment_methods')->where('payment_methods_id', $id)->update(['environment' => $env]);
