                                        ...
                                        <?php if(count($listingOrders['orders'])>0): ?>
                                            <?php $__currentLoopData = $listingOrders['orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$orderData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php if($orderData->currency == 'USD'): ?>
                                                            $
                                                        <?php endif; ?>
                                                        <?php if($orderData->currency == 'EUR'): ?>
                                                            €
                                                        <?php endif; ?>
                                                        <?php if($orderData->currency == 'GBP'): ?>
                                                            £
                                                        <?php endif; ?>
                                                        <?php echo e($orderData->order_price); ?></td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Php\intpayergrationpal-master\resources\views/admin/Orders/index.blade.php ENDPATH**/ ?>