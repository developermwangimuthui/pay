...
<header class="main-header">
    ...
    <a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>" class="logo">
      ...
      <span class="logo-lg"><img src="<?=url('/images/front_logo/pfa-2.png')?>" height="40px;" width="80px"><?php echo e(trans('labels.admin')); ?></span>
    </a>
...
<?php /**PATH D:\Php\intpayergrationpal-master\resources\views/admin/common/header.blade.php ENDPATH**/ ?>