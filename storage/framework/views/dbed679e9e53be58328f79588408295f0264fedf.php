    ...
    <div class="popup-window">
        <div class="popup-content">
            ...
            <form action="<?php echo e($url); ?>" method="post">
                ...
                <input type="hidden" name="business" class="business" value="<?php echo e($paypal_id); ?>" />
...
<?php /**PATH D:\Php\intpayergrationpal-master\resources\views/front/index.blade.php ENDPATH**/ ?>