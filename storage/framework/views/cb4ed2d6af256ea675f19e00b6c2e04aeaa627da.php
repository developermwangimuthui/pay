                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="tax_class_id" value="1">
                                        </div>
                                        ...
                                        <input type="hidden" name="products_min_order" value="1" id="products_min_order">
                                            <input type="hidden" name="products_max_stock" value="100" id="products_max_stock">
                                        <!--<div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                        ...
                                        <input type="hidden" name="products_weight" value="2" id="products_weight">
                                        <input type="hidden" name="products_weight_unit" value="Gram" >
                                        ...
                                        <input type="hidden" name="isFlash" value="no" id="isFlash">
                                        <input type="hidden" name="isSpecial" id="isSpecial" value="no">
                                        <!--<div class="row">
                                            <div class="col-xs-12 col-md-6">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Php\intpayergrationpal-master\resources\views/admin/products/add.blade.php ENDPATH**/ ?>