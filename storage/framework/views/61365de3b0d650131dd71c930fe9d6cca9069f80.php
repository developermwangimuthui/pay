    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(URL::to('admin/orders/display')); ?>"><i
                            class="fa fa-dashboard"></i> <?php echo e(trans('labels.ListingAllOrders')); ?></a></li>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="page-header" style="padding-bottom: 25px; margin-top:0;">
                        <i class="fa fa-globe"></i> <?php echo e(trans('labels.OrderID')); ?>

                        # <?php echo e($data['orders_data'][0]->orders_id); ?>

                        <small style="display: inline-block"><?php echo e(trans('labels.OrderedDate')); ?>

                            : <?php echo e(date('m/d/Y', strtotime($data['orders_data'][0]->date_purchased))); ?></small>
                        <a href="<?php echo e(URL::to('admin/orders/downloadPdf/'.$data['orders_data'][0]->orders_id)); ?>"
                           target="_blank" class="btn btn-default pull-right"><i class="fa fa-download"></i>
                            Download</a>
                    </h2>
                </div>
                <!-- /.col -->
                            ...
                            <select class="form-control select2" id="status_id" name="orders_status"
                                ...
                                <?php $__currentLoopData = $data['orders_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orders_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($orders_status->orders_status_id); ?>"
                                            <?php if( $data['orders_data'][0]->orders_status_id == $orders_status->orders_status_id): ?> selected="selected" <?php endif; ?> ><?php echo e($orders_status->orders_status_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <span class="help-block"
                                  style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.ChooseStatus')); ?></span>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <span class="help-block"
                                  style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.CommentsOrderText')); ?></span>
                        </div>
                    </div>
                </div>
                <!-- this row will not appear when printing -->
                <div class="col-xs-12">
                    <a href="<?php echo e(URL::to('admin/orders/display')); ?>" class="btn btn-default"><i
                            class="fa fa-angle-left"></i> <?php echo e(trans('labels.back')); ?></a>
                    <button type="submit" class="btn btn-success pull-right"><i
                            class="fa fa-credit-card"></i> <?php echo e(trans('labels.Submit')); ?> </button>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Php\intpayergrationpal-master\resources\views/admin/Orders/vieworder.blade.php ENDPATH**/ ?>