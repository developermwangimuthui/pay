                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <label class=" control-label">
                                                            <input type="radio" name="enviroment" value="0"
                                                                class="flat-red"
                                                                   <?php if($result['payment_methods']['environment']==0){echo 'checked' ;}else{echo '';} ?>
                                                        ...
                                                        <label class=" control-label">
                                                            <input type="radio" name="enviroment" value="1"
                                                                class="flat-red"
                                                            <?php if($result['payment_methods']['environment']==1){echo 'checked' ;}else{echo '';} ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\intpayergrationpal-master\resources\views/admin/paymentmethods/display.blade.php ENDPATH**/ ?>