    ...
    <div class="container">
        <div class="wpmk-form">
            <p class="form-text-head">
                ...
                if(session('data')){
                    echo "<h3>".session('data')->first_name." ". session('data')->last_name.", <br> you did not made any payment and this payment is now cancel.</h3>";

                }else{
                    echo "<h3> Please Make a Payment</h3>";
                }
                echo '<a href="services">Go Back</a>';
                Session::forget('data');
                unset($_REQUEST);
                ?>
            </p>
