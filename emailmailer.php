...
try {
    ...
    $mail->Username   = 'services@pfamart.com';                     // SMTP username
    $mail->Password   = '4e93F,UU82c4';                               // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('services@pfamart.com', 'Mailer');
    $mail->addAddress($email, '');     // Add a recipient
    $mail->addAddress('ellen@example.com');               // Name is optional
    $mail->addReplyTo('support@pfamart.com', 'PFA Support');
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  ...
                  <tr>
                    <td align="left" style="padding:50px 50px 50px 50px">
                     ...
                     <img src="https://pfaccounts.com/wp-content/uploads/2019/10/pfa-2.png" alt="Image" style="margin-bottom: 50px !important; margin-right: 0px !important; width:   100px;height:  50px;" >
                    <p style="color:#262626; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif"><strong>'.$subject.'</strong>,</p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">'.$message.'<br />
                        <br />
                        <br />
                      </p>
                        ...
                        <table class="contents" style="border-spacing:0; width:100%">
                          <tr>
                            ...
                            <td width="61%" align="left" valign="middle" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">
                                <p class="footer-text" style="color:#787777; font-size:13px; font-family: Verdana, Geneva, sans-serif"> Copyright &copy;  2019-2020 Premium Freelancing Accounts All rights reserved.<p/>
                                </td>
                          </tr>
                        </table>
                      </div>
                            ...
                            <td class="inner" style="padding-top:0px;padding-bottom:10px; padding-right:10px;padding-left:10px;"><table class="contents" style="border-spacing:0; width:100%">
                                <tr>
                                  <td width="32%" align="center" valign="top" style="padding-top:10px"><table width="150" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="33" align="center"><a href="https://web.facebook.com/pfaccounts" target="_blank"><img src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/1f9161ee-46b5-4bdf-86db-9e32d4b98336.jpg" alt="facebook" width="36" height="36" border="0" style="border-width:0; max-width:36px;height:auto; display:block; max-height:36px"/></a></td>
                                        <td width="34" align="center"><a href="https://www.instagram.com/pfaccounts_official " target="_blank"><img src="https://pfamart.com/image/insta.png" alt="instagram" width="36" height="36" border="0" style="border-width:0; max-width:36px;height:auto; display:block; max-height:36px"/></a></td>
                                        <td width="33" align="center"><a href="https://www.linkedin.com/company/pfaccounts" target="_blank"><img src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/d21cca91-335e-4fa4-9313-b0ea37e0452b.jpg" alt="linkedin" width="36" height="36" border="0" style="border-width:0; max-width:36px;height:auto; display:block; max-height:36px"/></a></td>
                                      </tr>
                                    </table></td>
                                </tr>
                              </table></td>
